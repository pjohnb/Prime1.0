...
const HELP_GLOSSARY = [
  ...
  { term: "MMR",             def: "Metals Mean-Reversion Scanner. Scans GLD, SLV, GDX, GDXJ and the broader metals universe. LONG signals fire on the full universe at TRANCHE_2 threshold. SHORT signals are ETF-only (SLV, GLD, GDX, GDXJ). MMR + PSA confirmation feeds Type 8 (Sniper Metals) scenarios." },
...
const STRATEGY_INFO = {
  ...
  MMR: {
    ...
    summary: "Scans GLD, SLV, GDX, GDXJ and the broader metals universe for RSI mean-reversion setups. LONG signals fire on the full universe (GLD, SLV, GDX, GDXJ, NEM, WPM, AG, PAAS, HL, FR) at TRANCHE_2 threshold. SHORT signals are ETF-only (SLV, GLD, GDX, GDXJ) — individual miners are LONG-only. Combined with PSA confirmation, MMR feeds Type 8 (Sniper Metals) scenarios.",
    ...
    confirmation: "LONG signals require TRANCHE_2 (Phase 1 condition + confirmed RSI turn + directional price move). SHORT signals require SHORT_TRANCHE_2 equivalently. TRANCHE_1 / SHORT_TRANCHE_1 = Phase 1 met, awaiting Phase 2 confirmation.",
    ...
    good: "RSI deeply oversold/overbought, volume surge confirming, gold/silver ratio supporting the thesis, DK CONFIRMING.",
    bad: "RSI only moderately extended, no volume surge, ratio context neutral or opposing.",
  },
  IDX: {
