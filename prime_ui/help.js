...
const HELP_GLOSSARY = [
  ...
  { term: "MMR",             def: "Metals Mean-Reversion Scanner. Uses RSI(14) to identify oversold bounce (LONG) and overbought reversal (SHORT) conditions on 10 precious metals instruments." },
